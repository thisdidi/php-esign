...
namespace Conle\ESign;

use Conle\ESign\Core\AbstractAPI;
use Conle\ESign\Core\AccessToken;
use Conle\ESign\Core\Http;
 ...
 * Class Application
 *
 * @property \Conle\ESign\Core\AccessToken $access_token
 * @property \Conle\ESign\Account\Account $account
 * @property \Conle\ESign\File\File $file
 * @property \Conle\ESign\SignFlow\SignFlow $signflow
 *
 * @package Conle\ESign
 */
